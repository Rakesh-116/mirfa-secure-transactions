...
exports.insertTxRecord = insertTxRecord;
exports.getTxRecordById = getTxRecordById;
exports.getTxRecordsByParty = getTxRecordsByParty;
const pool_1 = require("./pool");
/**
 * Insert a new encrypted transaction record
 */
async function insertTxRecord(record) {
 ...
 */
async function getTxRecordById(id) {
    const pool = (0, pool_1.getPool)();
 ...
 */
async function getTxRecordsByParty(partyId) {
    const pool = (0, pool_1.getPool)();
    const result = await pool.query(`
    SELECT 
      id, party_id, created_at, payload_nonce, payload_ct, payload_tag,
